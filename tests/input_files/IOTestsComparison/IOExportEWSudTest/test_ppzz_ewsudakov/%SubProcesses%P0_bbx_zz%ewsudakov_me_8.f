      SUBROUTINE EWSDK_ME_8(P,NHEL,ANS_SUMMED)
C     
...
C         endif
      ...
      CALL EWSUDAKOV_ME_8_SPLITORDERS(P,NHEL,ANS)
      ANS_SUMMED = (0D0,0D0)
      MAX_VAL = 0D0
...
C     this is to avoid fake non-zero contributions 
      ...
      SUBROUTINE EWSUDAKOV_ME_8_SPLITORDERS(P,NHEL,ANS)
C     
C     Generated by MadGraph5_aMC@NLO v. %(version)s, %(date)s
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 1
      CALL VVV1_0(W(1,5),W(1,4),W(1,3),-GC_3,AMP2(1))
      CALL FFV2_3P0_3(W(1,1),W(1,2),GC_68,GC_76,MDL_MZ,MDL_WZ,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VVV1_0(W(1,4),W(1,3),W(1,5),-GC_70,AMP2(2))
      CALL FFV2_2(W(1,1),W(1,4),GC_124,MDL_MT,MDL_WT,W(1,5))
