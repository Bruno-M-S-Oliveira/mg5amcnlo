...
C     and
C     Process: t b~ > w+ z [ LOonly = QCD QED ] QCD^2=2 QED^2=4
C     
C     
C     CONSTANTS
C     
...
C     Reshuffle the momenta here
      P_SAVE(:,:) = P(:,:)
      PASS_RESHUFFLE = .TRUE.
      CALL RESHUFFLE_MOMENTA(P,P_RESH,(/1,3/),(/5,23/),(/6,24/)
     $ ,PASS_RESHUFFLE)
      P(:,:)=P_RESH(:,:)
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFS3_3(W(1,1),W(1,2),GC_30,MDL_MW,MDL_WW,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VVS1_0(W(1,3),W(1,4),W(1,5),GC_84,AMP2(2))
      CALL FFV2_2(W(1,1),W(1,3),GC_124,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_3_0(W(1,5),W(1,2),W(1,4),GC_68,GC_76,AMP2(3))
      CALL FFV2_5_2(W(1,1),W(1,4),-GC_68,GC_76,MDL_MT,MDL_WT,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFV2_0(W(1,5),W(1,2),W(1,3),GC_124,AMP2(4))
C     JAMPs contributing to orders QCD=0 QED=2
      JAMP2(1,1) = AMP2(1)+AMP2(2)+AMP2(3)+AMP2(4)
