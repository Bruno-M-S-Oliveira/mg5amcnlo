...
C     and
C     Process: t b~ > z w+ [ LOonly = QCD QED ] QCD^2=2 QED^2=4
C     
C     
C     CONSTANTS
C     
...
C     Reshuffle the momenta here
      P_SAVE(:,:) = P(:,:)
      PASS_RESHUFFLE = .TRUE.
      CALL RESHUFFLE_MOMENTA(P,P_RESH,(/1,4/),(/5,23/),(/6,24/)
     $ ,PASS_RESHUFFLE)
      P(:,:)=P_RESH(:,:)
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV2_5_2(W(1,1),W(1,3),-GC_68,GC_76,MDL_MT,MDL_WT,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_0(W(1,5),W(1,2),W(1,4),GC_124,AMP2(3))
      CALL FFV2_2(W(1,1),W(1,4),GC_124,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 4
      CALL FFV2_3_0(W(1,5),W(1,2),W(1,3),GC_68,GC_76,AMP2(4))
C     JAMPs contributing to orders QCD=0 QED=2
