...
C     and
C     Process: t~ t > z z [ LOonly = QCD QED ] QCD^2=2 QED^2=4
C     
C     
C     CONSTANTS
C     
...
C     Helas calls and color basis for the Sudakov amplitude
      ...
      CALL VXXXXX(P(0,3),MDL_MZ,NHEL(3),+1*IC(3),W(1,3))
      CALL VXXXXX(P(0,4),MDL_MZ,NHEL(4),+1*IC(4),W(1,4))
      CALL FFS4_3(W(1,2),W(1,1),GC_116,MDL_MH,MDL_WH,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL VVS1_0(W(1,3),W(1,4),W(1,5),GC_99,AMP2(1))
      CALL FFV2_5_1(W(1,1),W(1,3),-GC_68,GC_76,MDL_MT,MDL_WT,W(1,5))
C     Amplitude(s) for diagram number 2
