...
C     and
C     Process: b t~ > w- z [ LOonly = QCD QED ] QCD^2=2 QED^2=4
C     
C     
C     CONSTANTS
C     
...
C     Reshuffle the momenta here
      P_SAVE(:,:) = P(:,:)
      PASS_RESHUFFLE = .TRUE.
      CALL RESHUFFLE_MOMENTA(P,P_RESH,(/2,3/),(/-5,23/),(/-6,-24/)
     $ ,PASS_RESHUFFLE)
      P(:,:)=P_RESH(:,:)
...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFS1_3(W(1,1),W(1,2),-GC_30,MDL_MW,MDL_WW,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL VVS1_0(W(1,3),W(1,4),W(1,5),-GC_84,AMP2(2))
      CALL FFV2_2(W(1,1),W(1,3),GC_124,MDL_MT,MDL_WT,W(1,5))
C     Amplitude(s) for diagram number 3
      CALL FFV2_5_0(W(1,5),W(1,2),W(1,4),-GC_68,GC_76,AMP2(3))
      CALL FFV2_3_2(W(1,1),W(1,4),GC_68,GC_76,ZERO,ZERO,W(1,5))
